...
def main() -> int:
    print("🚀 Starting vocabulous publish process...")
    ...
    run(["gh", "release", "create", tag, "--title", f"vocabulous v{version}", "--notes-file", notes_path])

    print("🎉 vocabulous publish process completed successfully!")
